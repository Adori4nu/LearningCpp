...
auto main() -> int
{
    my_junk::RedBlackTree<int> empty_int_tree;
    std::cout << empty_int_tree << "\n";
    my_junk::RedBlackTree int_tree{69};
    std::cout << int_tree << "\n";

    my_junk::RedBlackTree<std::string> string_tree{"noice"};
    ...
    << "\033[0m\n";
    my_junk::RedBlackTree<float> floating_tree;
